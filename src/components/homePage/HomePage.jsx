    ...
    return (
        <div className="FullPage">
            <div className="TopOfPage">
                <img className="image1" src="public/assets/lexWDuster.jpg" alt="Cleaning" />
                <img className="image2" src="public/assets/LexClean2024-83.jpg" alt="Cleaning" />
                <img className="image3" src="public/assets/LexClean2024-63.jpg" alt="Cleaning" />
            </div>
